...
public class ViewContact extends JFrame implements Observer {
    ...
    public ViewContact(Contact c, ContactController contactControl, GroupController groupControl) {
        contact = c;
        ...
        label2 = new JLabel("View Contact", JLabel.CENTER);
        ...
        rowPanel = new JPanel();
        labelGroup = new JLabel("Contacts  groups ");
        ...
        ArrayList<Group> contactGroups = groupController.chercherGroupesParContact(c);
    ...
    public void update(Observable o, Object arg) {
        ...
        ArrayList<Group> contactGroups = groupController.chercherGroupesParContact(contact);
        if (contactGroups.isEmpty()) {
            JCheckBox noGroup = new JCheckBox("No Groups", true);
            styleCheckBox(noGroup);
            noGroup.setEnabled(false);
            panelCheck.add(noGroup);
        } else {
            for (Group group : contactGroups) {
                JCheckBox cb = new JCheckBox(group.getName(), true);
                cb.setEnabled(false);
                styleCheckBox(cb);
                panelCheck.add(cb);
            }
